  ...
  return (
    <SafeAreaView>
      ...
      <View className="h-screen bg-white flex justify-start items-center px-6 pt-6">
        <View className=" flex justify-center bg-white w-full rounded-2xl ">
          <Text>당신은 INFP유형</Text>
        </View>
        {/* 
          TODO: 선이 제대로 적용되지 않는 이슈 및 가운데 텍스트가 들어가는 이튜 해경해야함
        */}
        <View className="h-1/6 bg-white w-full rounded-2xl mt-2 justify-center items-center">
          <RadioButtons
        ...
        <View className="h-1/6 bg-white w-full rounded-2xl mt-2">
          <RadioButtons
